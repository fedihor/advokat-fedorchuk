...
insert into askpost (title, post, date_post, user_id) values ('Треба розірвати шлюб так, щоб квартира дісталась мені', 'Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium 
                            doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore 
                            veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim 
                            ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia
                            consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt.', now(), 1);
insert into askpost (title, post, date_post, user_id) values ('Як вивчитися на програміста: основна таємниця айтішної освіти', 'Свій перший сайт я написав на третьому курсі. Нашому «мистецькому об’єднанню» потрібно було своє представництво в інтернеті, де ми мали викладати вірші, відео з перфоменсів і маніфести постмодернізму, який помер. В нашому об’єднанні були поети, режисери, оператори і актори, а програмістом був чомусь я один. Тож вибору особливого не було: я сів і почав писати сайт.
...
більше у файлі не було взагалі нічого. «Ух ти», — сказав я йому, — «в тебе на один клас більше, ніж в мене!»', now(), 2);
